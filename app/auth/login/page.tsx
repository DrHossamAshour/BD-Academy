            ...
            <CardContent className="space-y-6">
                ...
                <div className="flex items-center justify-between">
                  <div className="flex items-center space-x-2">
                    <input
                      id="remember"
                      type="checkbox"
                      className="rounded border-gray-300 text-[#d8bf78] focus:ring-[#d8bf78]"
                    />
                    <Label htmlFor="remember" className="text-sm text-gray-600">
                      Remember me
                    </Label>
                  </div>
                  <Link href="/auth/forgot-password" className="text-sm text-[#d8bf78] hover:text-[#c4a86a]">
                    Forgot password?
                  </Link>
                </div>
              ...
              <div className="text-center">
                <p className="text-sm text-gray-600">
                  ...
                  <Link href="/auth/signup" className="text-[#d8bf78] hover:text-[#c4a86a] font-medium">
                    Sign up for free
                  </Link>
                </p>
              </div>
