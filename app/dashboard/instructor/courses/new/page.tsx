...
export default function CreateCoursePage() {
  ...
  const [courseData, setCourseData] = useState({
    ...
    maxStudents: "",
    accessDuration: "lifetime" // lifetime, 30days, 90days, 1year
  });
  ...
  const validateVimeoUrl = (url: string): { isValid: boolean; videoId?: string; error?: string } => {
    ...
    // Check if it's a valid Vimeo player URL
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Save course to database via API
      ...
      // Refresh the course list on the courses page
        ...
        <div className="container mx-auto px-4">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-xl opacity-90">Build engaging courses with protected video content</p>
            </div>
          </div>
        </div>
      </section>
